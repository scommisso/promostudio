...
namespace PromoStudio.Data
{
    public interface IDataWrapper
    {
        ...
        void ExecuteReader(string storedProcedureName, IEnumerable<IDbDataParameter> parameters,
        ...
        void ExecuteStoredProc(IDbConnection connection, string storedProcedure, int? commandTimeout = null,
        ...
        IEnumerable<T> QueryStoredProc<T>(IDbConnection connection, string storedProcedure, int? commandTimeout = null,
            dynamic dbParams = null, IDbTransaction transaction = null);

        Task<IEnumerable<T>> QueryStoredProcAsync<T>(string storedProcedure, int? commandTimeout = null,
            dynamic dbParams = null);

        Task<IEnumerable<T>> QueryStoredProcAsync<T>(IDbConnection connection, string storedProcedure,
