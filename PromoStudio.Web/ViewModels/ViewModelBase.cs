...
namespace PromoStudio.Web.ViewModels
{
    public abstract class ViewModelBase
    {
        ...
        {
            IsAccountController =
                string.Compare((string) routeData.Values["controller"], "Account", StringComparison.OrdinalIgnoreCase) ==
                0;
            IsBuildController =
                string.Compare((string) routeData.Values["controller"], "Build", StringComparison.OrdinalIgnoreCase) ==
                0;
        }
    }
}