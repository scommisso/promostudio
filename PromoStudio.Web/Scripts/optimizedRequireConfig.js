...
require.config({
    ...
    paths: {
        jquery: ["//ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min", "/optimizedScripts/lib/jquery-1.10.2"],
        ...
        knockout: ["//cdnjs.cloudflare.com/ajax/libs/knockout/3.0.0/knockout-min", "/optimizedScripts/lib/knockout-3.0.0"],
