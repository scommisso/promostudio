namespace PromoStudio.Common
{
    public static class Constants
    {
        public static class StoredProcedures
        {
            ...
            public const string CustomerVideoScriptSelectByCustomerVideoId_sp =
                "promostudio.CustomerVideoScriptSelectByCustomerVideoId_sp";
            ...
            public const string CustomerVideoVoiceOverSelectByCustomerVideoId_sp =
                "promostudio.CustomerVideoVoiceOverSelectByCustomerVideoId_sp";
            ...
            public const string CustomerResourceSelectActiveByCustomerId_sp =
                "promostudio.CustomerResourceSelectActiveByCustomerId_sp";

            public const string CustomerResourceSelectByCustomerTemplateScriptId_sp =
            ...
            public const string CustomerTemplateScriptItemSelectById_sp =
                "promostudio.CustomerTemplateScriptItemSelectById_sp";

            public const string CustomerTemplateScriptItemSelectByCustomerTemplateScriptId_sp =
                "promostudio.CustomerTemplateScriptItemSelectByCustomerTemplateScriptId_sp";
            ...
            public const string StockAudioSelectByCustomerVideoId_sp =
                "promostudio.StockAudioSelectByCustomerVideoId_sp";

            public const string StockAudioSelectByOrganizationIdAndVerticalId_sp =
                "promostudio.StockAudioSelectByOrganizationIdAndVerticalId_sp";

            public const string StockVideoSelectAll_sp = "promostudio.StockVideoSelectAll_sp";

            public const string StockVideoSelectByCustomerVideoId_sp =
                "promostudio.StockVideoSelectByCustomerVideoId_sp";

            public const string StockVideoSelectByOrganizationIdAndVerticalId_sp =
                "promostudio.StockVideoSelectByOrganizationIdAndVerticalId_sp";
            ...
            public const string StoryboardSelectByCustomerVideoId_sp =
                "promostudio.StoryboardSelectByCustomerVideoId_sp";

            public const string StoryboardSelectByOrganizationIdAndVerticalId_sp =
                "promostudio.StoryboardSelectByOrganizationIdAndVerticalId_sp";
            ...
            public const string StoryboardItemSelectByCustomerVideoId_sp =
                "promostudio.StoryboardItemSelectByCustomerVideoId_sp";

            public const string StoryboardItemSelectById_sp = "promostudio.StoryboardItemSelectById_sp";

            public const string StoryboardItemSelectByStoryboardId_sp =
                "promostudio.StoryboardItemSelectByStoryboardId_sp";
            ...
            public const string TemplateScriptSelectByOrganizationIdAndVerticalId_sp =
                "promostudio.TemplateScriptSelectByOrganizationIdAndVerticalId_sp";

            public const string TemplateScriptSelectByStoryboardId_sp =
                "promostudio.TemplateScriptSelectByStoryboardId_sp";

            public const string TemplateScriptItemSelectAll_sp = "promostudio.TemplateScriptItemSelectAll_sp";

            public const string TemplateScriptItemSelectByTemplateScriptId_sp =
                "promostudio.TemplateScriptItemSelectByTemplateScriptId_sp";

            public const string TemplateScriptItemSelectByStoryboardId_sp =
                "promostudio.TemplateScriptItemSelectByStoryboardId_sp";
